  ...
  return (
    <View style={styles.container}>
      <View>
        <Image
          style={styles.image}
          source={{ uri: 'https://blog.giulianaflores.com.br/wp-content/uploads/2016/05/como-cuidar-de-girassol.jpghttps://static.mundomax.com.br/produtos/79404/550/1.webp' }}
          transition={1000}
        >
